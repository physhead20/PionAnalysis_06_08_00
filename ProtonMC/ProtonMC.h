...
// Fri Jan  6 07:21:10 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ProtonMC.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[994];   //[nhits]
   Int_t           hit_wire[994];   //[nhits]
   Int_t           hit_channel[994];   //[nhits]
   Double_t        hit_peakT[994];   //[nhits]
   Double_t        hit_charge[994];   //[nhits]
   Double_t        hit_ph[994];   //[nhits]
   Double_t        hit_tstart[994];   //[nhits]
   Double_t        hit_tend[994];   //[nhits]
   Int_t           hit_trkid[994];   //[nhits]
   Int_t           hit_trkkey[994];   //[nhits]
   Int_t           hit_clukey[994];   //[nhits]
   Int_t           hit_pk[994];   //[nhits]
   Int_t           hit_t[994];   //[nhits]
   Int_t           hit_ch[994];   //[nhits]
   Int_t           hit_fwhh[994];   //[nhits]
   Double_t        hit_rms[994];   //[nhits]
   Double_t        hit_nelec[994];   //[nhits]
   Double_t        hit_energy[994];   //[nhits]
   Float_t         hit_dQds[994];   //[nhits]
   Float_t         hit_dEds[994];   //[nhits]
   Float_t         hit_ds[994];   //[nhits]
   Float_t         hit_resrange[994];   //[nhits]
   Float_t         hit_x[994];   //[nhits]
   Float_t         hit_y[994];   //[nhits]
   Float_t         hit_z[994];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3035];   //[maxTrackIDE]
   Double_t        IDEPos[3035][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[296];   //[geant_list_size]
   Double_t        Eng[296];   //[geant_list_size]
   Double_t        Px[296];   //[geant_list_size]
   Double_t        Py[296];   //[geant_list_size]
   Double_t        Pz[296];   //[geant_list_size]
   Double_t        EndEng[296];   //[geant_list_size]
   Double_t        EndPx[296];   //[geant_list_size]
   Double_t        EndPy[296];   //[geant_list_size]
   Double_t        EndPz[296];   //[geant_list_size]
   Double_t        StartPointx[296];   //[geant_list_size]
   Double_t        StartPointy[296];   //[geant_list_size]
   Double_t        StartPointz[296];   //[geant_list_size]
   Double_t        EndPointx[296];   //[geant_list_size]
   Double_t        EndPointy[296];   //[geant_list_size]
   Double_t        EndPointz[296];   //[geant_list_size]
   Int_t           Process[296];   //[geant_list_size]
   Int_t           NumberDaughters[296];   //[geant_list_size]
   Int_t           Mother[296];   //[geant_list_size]
   Int_t           TrackId[296];   //[geant_list_size]
   Int_t           process_primary[296];   //[geant_list_size]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/ProtonMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/ProtonMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/ProtonMC.root:/anatree");
