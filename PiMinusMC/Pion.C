...
///////////////////////////////// "Matched Track" dE/dX vs RR (Fixed) ///////////////////////////////////////////////
TH2D *hdataPiondEdXvsRRFixedDecCap = new TH2D("hdataPiondEdXvsRRFixedDecCap", "dE/dX vs Residual Range for Capture/Decay",200, 0, 100, 200, 0, 50);
...
TH1D *hdataLowMomentumTrkPIDACapDec = new TH1D("hdataLowMomentumTrkPIDACapDec", "Low Momentum PIDA", 30, 0, 30);
...
\
   ...
   for(int nTPCtrk = 0; nTPCtrk < ntracks_reco; nTPCtrk++)
	 ...
	 if(RunIScaledEdX)
	    {
	    Piondedx[nPionSpts]     = trkdedx[nTPCtrk][1][nspts]*(RunIScaleFactor);
	 ...
	 if(RunIIScaledEdX)
	    {
	    Piondedx[nPionSpts]     = trkdedx[nTPCtrk][1][nspts]*(RunIIScaleFactor);
	 ...
	 if(g4PrimaryProcess[0] == 4 || g4PrimaryProcess[0] == 12 || g4PrimaryProcess[0] == 6)
	 	{hdataLowMomentumTrkPIDACapDec->Fill(trkpida[nTPCtrk][1]);}
	...
	if(nPionSpts >= 5)
	   {
	      ...
	      {
	      if(Piondedx[nlastspts] == -99999){continue;}
	      
	      //std::cout<<"nlastspts = "<<nlastspts<<std::endl;
	      // ### Add up the energy in the last 5 points ###
	      lastDeltaEAll += (Pionpitchhit[nlastspts] * Piondedx[nlastspts]);
...
hdataLowMomentumTrkPIDACapDec->Write();
hdataPiondEdXvsRRFixedDecCap->Write();
