...
// Fri Oct 28 15:29:14 2016 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PionMC_Anatree.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[89];   //[nclus]
   Double_t        clusterttick[89];   //[nclus]
   Double_t        cluendwire[89];   //[nclus]
   Double_t        cluendtick[89];   //[nclus]
   Int_t           cluplane[89];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[31];   //[ntracks_reco]
   Double_t        trkvtxy[31];   //[ntracks_reco]
   Double_t        trkvtxz[31];   //[ntracks_reco]
   Double_t        trkendx[31];   //[ntracks_reco]
   Double_t        trkendy[31];   //[ntracks_reco]
   Double_t        trkendz[31];   //[ntracks_reco]
   Double_t        trkstartdcosx[31];   //[ntracks_reco]
   Double_t        trkstartdcosy[31];   //[ntracks_reco]
   Double_t        trkstartdcosz[31];   //[ntracks_reco]
   Double_t        trkenddcosx[31];   //[ntracks_reco]
   Double_t        trkenddcosy[31];   //[ntracks_reco]
   Double_t        trkenddcosz[31];   //[ntracks_reco]
   Int_t           trkWCtoTPCMath;
   Double_t        trklength[31];   //[ntracks_reco]
   Double_t        trkmomrange[31];   //[ntracks_reco]
   Double_t        trkmommschi2[31];   //[ntracks_reco]
   Double_t        trkmommsllhd[31];   //[ntracks_reco]
   Int_t           ntrkhits[31];   //[ntracks_reco]
   Double_t        trkx[31][1000];   //[ntracks_reco]
   Double_t        trky[31][1000];   //[ntracks_reco]
   Double_t        trkz[31][1000];   //[ntracks_reco]
   Double_t        trkpitch[31][2];   //[ntracks_reco]
   Int_t           trkhits[31][2];   //[ntracks_reco]
   Double_t        trkdedx[31][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[31][2][1000];   //[ntracks_reco]
   Double_t        trkrr[31][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[31][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[31][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[31][2];   //[ntracks_reco]
   Double_t        trkpida[31][2];   //[ntracks_reco]
   Int_t           nTrajPoint[31];   //[ntracks_reco]
   Double_t        pHat0_X[31][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[31][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[31][1000];   //[ntracks_reco]
   Double_t        trjPt_X[31][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[31][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[31][1000];   //[ntracks_reco]
   Int_t           trkg4id[31];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1438];   //[nhits]
   Int_t           hit_wire[1438];   //[nhits]
   Int_t           hit_channel[1438];   //[nhits]
   Double_t        hit_peakT[1438];   //[nhits]
   Double_t        hit_charge[1438];   //[nhits]
   Double_t        hit_ph[1438];   //[nhits]
   Double_t        hit_tstart[1438];   //[nhits]
   Double_t        hit_tend[1438];   //[nhits]
   Int_t           hit_trkid[1438];   //[nhits]
   Int_t           hit_trkkey[1438];   //[nhits]
   Int_t           hit_clukey[1438];   //[nhits]
   Int_t           hit_pk[1438];   //[nhits]
   Int_t           hit_t[1438];   //[nhits]
   Int_t           hit_ch[1438];   //[nhits]
   Int_t           hit_fwhh[1438];   //[nhits]
   Double_t        hit_rms[1438];   //[nhits]
   Double_t        hit_nelec[1438];   //[nhits]
   Double_t        hit_energy[1438];   //[nhits]
   Float_t         hit_dQds[1438];   //[nhits]
   Float_t         hit_dEds[1438];   //[nhits]
   Float_t         hit_ds[1438];   //[nhits]
   Float_t         hit_resrange[1438];   //[nhits]
   Float_t         hit_x[1438];   //[nhits]
   Float_t         hit_y[1438];   //[nhits]
   Float_t         hit_z[1438];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3976];   //[maxTrackIDE]
   Double_t        IDEPos[3976][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[360];   //[geant_list_size]
   Double_t        Eng[360];   //[geant_list_size]
   Double_t        Px[360];   //[geant_list_size]
   Double_t        Py[360];   //[geant_list_size]
   Double_t        Pz[360];   //[geant_list_size]
   Double_t        EndEng[360];   //[geant_list_size]
   Double_t        EndPx[360];   //[geant_list_size]
   Double_t        EndPy[360];   //[geant_list_size]
   Double_t        EndPz[360];   //[geant_list_size]
   Double_t        StartPointx[360];   //[geant_list_size]
   Double_t        StartPointy[360];   //[geant_list_size]
   Double_t        StartPointz[360];   //[geant_list_size]
   Double_t        EndPointx[360];   //[geant_list_size]
   Double_t        EndPointy[360];   //[geant_list_size]
   Double_t        EndPointz[360];   //[geant_list_size]
   Int_t           Process[360];   //[geant_list_size]
   Int_t           NumberDaughters[360];   //[geant_list_size]
   Int_t           Mother[360];   //[geant_list_size]
   Int_t           TrackId[360];   //[geant_list_size]
   Int_t           process_primary[360];   //[geant_list_size]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PionMC_Anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PionMC_Anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PionMC_Anatree.root:/anatree");
