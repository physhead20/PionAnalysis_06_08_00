...
// Sun Nov  6 01:16:28 2016 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ElectronMinusMC.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[106];   //[nclus]
   Double_t        clusterttick[106];   //[nclus]
   Double_t        cluendwire[106];   //[nclus]
   Double_t        cluendtick[106];   //[nclus]
   Int_t           cluplane[106];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1730];   //[nhits]
   Int_t           hit_wire[1730];   //[nhits]
   Int_t           hit_channel[1730];   //[nhits]
   Double_t        hit_peakT[1730];   //[nhits]
   Double_t        hit_charge[1730];   //[nhits]
   Double_t        hit_ph[1730];   //[nhits]
   Double_t        hit_tstart[1730];   //[nhits]
   Double_t        hit_tend[1730];   //[nhits]
   Int_t           hit_trkid[1730];   //[nhits]
   Int_t           hit_trkkey[1730];   //[nhits]
   Int_t           hit_clukey[1730];   //[nhits]
   Int_t           hit_pk[1730];   //[nhits]
   Int_t           hit_t[1730];   //[nhits]
   Int_t           hit_ch[1730];   //[nhits]
   Int_t           hit_fwhh[1730];   //[nhits]
   Double_t        hit_rms[1730];   //[nhits]
   Double_t        hit_nelec[1730];   //[nhits]
   Double_t        hit_energy[1730];   //[nhits]
   Float_t         hit_dQds[1730];   //[nhits]
   Float_t         hit_dEds[1730];   //[nhits]
   Float_t         hit_ds[1730];   //[nhits]
   Float_t         hit_resrange[1730];   //[nhits]
   Float_t         hit_x[1730];   //[nhits]
   Float_t         hit_y[1730];   //[nhits]
   Float_t         hit_z[1730];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2632];   //[maxTrackIDE]
   Double_t        IDEPos[2632][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[175];   //[geant_list_size]
   Double_t        Eng[175];   //[geant_list_size]
   Double_t        Px[175];   //[geant_list_size]
   Double_t        Py[175];   //[geant_list_size]
   Double_t        Pz[175];   //[geant_list_size]
   Double_t        EndEng[175];   //[geant_list_size]
   Double_t        EndPx[175];   //[geant_list_size]
   Double_t        EndPy[175];   //[geant_list_size]
   Double_t        EndPz[175];   //[geant_list_size]
   Double_t        StartPointx[175];   //[geant_list_size]
   Double_t        StartPointy[175];   //[geant_list_size]
   Double_t        StartPointz[175];   //[geant_list_size]
   Double_t        EndPointx[175];   //[geant_list_size]
   Double_t        EndPointy[175];   //[geant_list_size]
   Double_t        EndPointz[175];   //[geant_list_size]
   Int_t           Process[175];   //[geant_list_size]
   Int_t           NumberDaughters[175];   //[geant_list_size]
   Int_t           Mother[175];   //[geant_list_size]
   Int_t           TrackId[175];   //[geant_list_size]
   Int_t           process_primary[175];   //[geant_list_size]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/ElectronMinusMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/ElectronMinusMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/ElectronMinusMC.root:/anatree");
