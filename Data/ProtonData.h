...
// Thu Jan  5 09:47:59 2017 by ROOT version 5.34/36
...
#ifdef ProtonData_cxx
ProtonData::ProtonData(TTree *tree) : fChain(0) 
{
...
Int_t ProtonData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProtonData::LoadTree(Long64_t entry)
{
...
void ProtonData::Init(TTree *tree)
{
...
void ProtonData::Show(Long64_t entry)
{
...
Int_t ProtonData::Cut(Long64_t entry)
{
