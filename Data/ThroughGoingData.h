...
// Thu Jan 19 04:04:18 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunINegPol_AnaTree.root
//////////////////////////////////////////////////////////

#ifndef ThroughGoingData_h
#define ThroughGoingData_h
...
public :
   ...
   ThroughGoingData(TTree *tree=0);
   virtual ~ThroughGoingData();
...
#ifdef ThroughGoingData_cxx
ThroughGoingData::ThroughGoingData(TTree *tree) : fChain(0) 
{
...
ThroughGoingData::~ThroughGoingData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ThroughGoingData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ThroughGoingData::LoadTree(Long64_t entry)
{
...
void ThroughGoingData::Init(TTree *tree)
{
...
Bool_t ThroughGoingData::Notify()
{
...
void ThroughGoingData::Show(Long64_t entry)
{
...
Int_t ThroughGoingData::Cut(Long64_t entry)
{
...
#endif // #ifdef ThroughGoingData_cxx
