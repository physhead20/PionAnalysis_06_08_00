...
// Fri Oct 28 14:09:18 2016 by ROOT version 6.06/08
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunINegPol_AnaTree.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           ntracks_reco;
   Double_t        trkvtxx[135];   //[ntracks_reco]
   Double_t        trkvtxy[135];   //[ntracks_reco]
   Double_t        trkvtxz[135];   //[ntracks_reco]
   Double_t        trkendx[135];   //[ntracks_reco]
   Double_t        trkendy[135];   //[ntracks_reco]
   Double_t        trkendz[135];   //[ntracks_reco]
   Double_t        trkstartdcosx[135];   //[ntracks_reco]
   Double_t        trkstartdcosy[135];   //[ntracks_reco]
   Double_t        trkstartdcosz[135];   //[ntracks_reco]
   Double_t        trkenddcosx[135];   //[ntracks_reco]
   Double_t        trkenddcosy[135];   //[ntracks_reco]
   Double_t        trkenddcosz[135];   //[ntracks_reco]
   Int_t           trkWCtoTPCMath;
   Double_t        trklength[135];   //[ntracks_reco]
   Double_t        trkmomrange[135];   //[ntracks_reco]
   Double_t        trkmommschi2[135];   //[ntracks_reco]
   Double_t        trkmommsllhd[135];   //[ntracks_reco]
   Int_t           ntrkhits[135];   //[ntracks_reco]
   Double_t        trkx[135][1000];   //[ntracks_reco]
   Double_t        trky[135][1000];   //[ntracks_reco]
   Double_t        trkz[135][1000];   //[ntracks_reco]
   Double_t        trkpitch[135][2];   //[ntracks_reco]
   Int_t           trkhits[135][2];   //[ntracks_reco]
   Double_t        trkdedx[135][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[135][2][1000];   //[ntracks_reco]
   Double_t        trkrr[135][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[135][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[135][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[135][2];   //[ntracks_reco]
   Double_t        trkpida[135][2];   //[ntracks_reco]
   Int_t           nTrajPoint[135];   //[ntracks_reco]
   Double_t        pHat0_X[135][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[135][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[135][1000];   //[ntracks_reco]
   Double_t        trjPt_X[135][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[135][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[135][1000];   //[ntracks_reco]
   Int_t           trkg4id[135];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/RunINegPol_AnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/RunINegPol_AnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/RunINegPol_AnaTree.root:/anatree");
