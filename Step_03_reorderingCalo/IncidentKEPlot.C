...
TFile *f3 = new TFile("./histo_ROOTFILES/MuonMC_PionXSection_histos_wScalings_dEdXScale_Reordering.root");

// ###################################
// ### Load Muon Monte Carlo Plots ###
// ###################################
//TFile *f4 = new TFile("./histo_ROOTFILES/ElectronMC_PionXSection_histos_noCorrections_noScalings.root");
TFile *f4 = new TFile("./histo_ROOTFILES/ElectronMC_PionXSection_histos_wScalings_dEdXScale_Reordering.root");

// ###################################
// ### Load Kaon Monte Carlo Plots ###
// ###################################
TFile *f5 = new TFile("./histo_ROOTFILES/KaonMC_PionXSection_histos_wScalings_dEdXScale_Reordering.root");

// #####################################
// ### Load Photon Monte Carlo Plots ###
// #####################################
TFile *f6 = new TFile("./histo_ROOTFILES/PhotonMC_PionXSection_histos_wScalings_dEdXScale_Reordering.root");
