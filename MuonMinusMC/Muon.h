...
// Wed Nov  9 12:55:26 2016 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/MuonMinusMC.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[38];   //[nclus]
   Double_t        clusterttick[38];   //[nclus]
   Double_t        cluendwire[38];   //[nclus]
   Double_t        cluendtick[38];   //[nclus]
   Int_t           cluplane[38];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[10];   //[ntracks_reco]
   Double_t        trkvtxy[10];   //[ntracks_reco]
   Double_t        trkvtxz[10];   //[ntracks_reco]
   Double_t        trkendx[10];   //[ntracks_reco]
   Double_t        trkendy[10];   //[ntracks_reco]
   Double_t        trkendz[10];   //[ntracks_reco]
   Double_t        trkstartdcosx[10];   //[ntracks_reco]
   Double_t        trkstartdcosy[10];   //[ntracks_reco]
   Double_t        trkstartdcosz[10];   //[ntracks_reco]
   Double_t        trkenddcosx[10];   //[ntracks_reco]
   Double_t        trkenddcosy[10];   //[ntracks_reco]
   Double_t        trkenddcosz[10];   //[ntracks_reco]
   Int_t           trkWCtoTPCMath;
   Double_t        trklength[10];   //[ntracks_reco]
   Double_t        trkmomrange[10];   //[ntracks_reco]
   Double_t        trkmommschi2[10];   //[ntracks_reco]
   Double_t        trkmommsllhd[10];   //[ntracks_reco]
   Int_t           ntrkhits[10];   //[ntracks_reco]
   Double_t        trkx[10][1000];   //[ntracks_reco]
   Double_t        trky[10][1000];   //[ntracks_reco]
   Double_t        trkz[10][1000];   //[ntracks_reco]
   Double_t        trkpitch[10][2];   //[ntracks_reco]
   Int_t           trkhits[10][2];   //[ntracks_reco]
   Double_t        trkdedx[10][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[10][2][1000];   //[ntracks_reco]
   Double_t        trkrr[10][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[10][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[10][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[10][2];   //[ntracks_reco]
   Double_t        trkpida[10][2];   //[ntracks_reco]
   Int_t           nTrajPoint[10];   //[ntracks_reco]
   Double_t        pHat0_X[10][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[10][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[10][1000];   //[ntracks_reco]
   Double_t        trjPt_X[10][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[10][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[10][1000];   //[ntracks_reco]
   Int_t           trkg4id[10];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[778];   //[nhits]
   Int_t           hit_wire[778];   //[nhits]
   Int_t           hit_channel[778];   //[nhits]
   Double_t        hit_peakT[778];   //[nhits]
   Double_t        hit_charge[778];   //[nhits]
   Double_t        hit_ph[778];   //[nhits]
   Double_t        hit_tstart[778];   //[nhits]
   Double_t        hit_tend[778];   //[nhits]
   Int_t           hit_trkid[778];   //[nhits]
   Int_t           hit_trkkey[778];   //[nhits]
   Int_t           hit_clukey[778];   //[nhits]
   Int_t           hit_pk[778];   //[nhits]
   Int_t           hit_t[778];   //[nhits]
   Int_t           hit_ch[778];   //[nhits]
   Int_t           hit_fwhh[778];   //[nhits]
   Double_t        hit_rms[778];   //[nhits]
   Double_t        hit_nelec[778];   //[nhits]
   Double_t        hit_energy[778];   //[nhits]
   Float_t         hit_dQds[778];   //[nhits]
   Float_t         hit_dEds[778];   //[nhits]
   Float_t         hit_ds[778];   //[nhits]
   Float_t         hit_resrange[778];   //[nhits]
   Float_t         hit_x[778];   //[nhits]
   Float_t         hit_y[778];   //[nhits]
   Float_t         hit_z[778];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2959];   //[maxTrackIDE]
   Double_t        IDEPos[2959][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[75];   //[geant_list_size]
   Double_t        Eng[75];   //[geant_list_size]
   Double_t        Px[75];   //[geant_list_size]
   Double_t        Py[75];   //[geant_list_size]
   Double_t        Pz[75];   //[geant_list_size]
   Double_t        EndEng[75];   //[geant_list_size]
   Double_t        EndPx[75];   //[geant_list_size]
   Double_t        EndPy[75];   //[geant_list_size]
   Double_t        EndPz[75];   //[geant_list_size]
   Double_t        StartPointx[75];   //[geant_list_size]
   Double_t        StartPointy[75];   //[geant_list_size]
   Double_t        StartPointz[75];   //[geant_list_size]
   Double_t        EndPointx[75];   //[geant_list_size]
   Double_t        EndPointy[75];   //[geant_list_size]
   Double_t        EndPointz[75];   //[geant_list_size]
   Int_t           Process[75];   //[geant_list_size]
   Int_t           NumberDaughters[75];   //[geant_list_size]
   Int_t           Mother[75];   //[geant_list_size]
   Int_t           TrackId[75];   //[geant_list_size]
   Int_t           process_primary[75];   //[geant_list_size]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/MuonMinusMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/MuonMinusMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/MuonMinusMC.root:/anatree");
