...
// Thu Nov 10 19:28:23 2016 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PhotonMC.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[105];   //[nclus]
   Double_t        clusterttick[105];   //[nclus]
   Double_t        cluendwire[105];   //[nclus]
   Double_t        cluendtick[105];   //[nclus]
   Int_t           cluplane[105];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1674];   //[nhits]
   Int_t           hit_wire[1674];   //[nhits]
   Int_t           hit_channel[1674];   //[nhits]
   Double_t        hit_peakT[1674];   //[nhits]
   Double_t        hit_charge[1674];   //[nhits]
   Double_t        hit_ph[1674];   //[nhits]
   Double_t        hit_tstart[1674];   //[nhits]
   Double_t        hit_tend[1674];   //[nhits]
   Int_t           hit_trkid[1674];   //[nhits]
   Int_t           hit_trkkey[1674];   //[nhits]
   Int_t           hit_clukey[1674];   //[nhits]
   Int_t           hit_pk[1674];   //[nhits]
   Int_t           hit_t[1674];   //[nhits]
   Int_t           hit_ch[1674];   //[nhits]
   Int_t           hit_fwhh[1674];   //[nhits]
   Double_t        hit_rms[1674];   //[nhits]
   Double_t        hit_nelec[1674];   //[nhits]
   Double_t        hit_energy[1674];   //[nhits]
   Float_t         hit_dQds[1674];   //[nhits]
   Float_t         hit_dEds[1674];   //[nhits]
   Float_t         hit_ds[1674];   //[nhits]
   Float_t         hit_resrange[1674];   //[nhits]
   Float_t         hit_x[1674];   //[nhits]
   Float_t         hit_y[1674];   //[nhits]
   Float_t         hit_z[1674];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           pdg[196];   //[geant_list_size]
   Double_t        Eng[196];   //[geant_list_size]
   Double_t        Px[196];   //[geant_list_size]
   Double_t        Py[196];   //[geant_list_size]
   Double_t        Pz[196];   //[geant_list_size]
   Double_t        EndEng[196];   //[geant_list_size]
   Double_t        EndPx[196];   //[geant_list_size]
   Double_t        EndPy[196];   //[geant_list_size]
   Double_t        EndPz[196];   //[geant_list_size]
   Double_t        StartPointx[196];   //[geant_list_size]
   Double_t        StartPointy[196];   //[geant_list_size]
   Double_t        StartPointz[196];   //[geant_list_size]
   Double_t        EndPointx[196];   //[geant_list_size]
   Double_t        EndPointy[196];   //[geant_list_size]
   Double_t        EndPointz[196];   //[geant_list_size]
   Int_t           Process[196];   //[geant_list_size]
   Int_t           NumberDaughters[196];   //[geant_list_size]
   Int_t           Mother[196];   //[geant_list_size]
   Int_t           TrackId[196];   //[geant_list_size]
   Int_t           process_primary[196];   //[geant_list_size]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PhotonMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PhotonMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PhotonMC.root:/anatree");
