...
// Thu Nov 10 07:42:36 2016 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/KaonMinusMC.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[102];   //[nclus]
   Double_t        clusterttick[102];   //[nclus]
   Double_t        cluendwire[102];   //[nclus]
   Double_t        cluendtick[102];   //[nclus]
   Int_t           cluplane[102];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1620];   //[nhits]
   Int_t           hit_wire[1620];   //[nhits]
   Int_t           hit_channel[1620];   //[nhits]
   Double_t        hit_peakT[1620];   //[nhits]
   Double_t        hit_charge[1620];   //[nhits]
   Double_t        hit_ph[1620];   //[nhits]
   Double_t        hit_tstart[1620];   //[nhits]
   Double_t        hit_tend[1620];   //[nhits]
   Int_t           hit_trkid[1620];   //[nhits]
   Int_t           hit_trkkey[1620];   //[nhits]
   Int_t           hit_clukey[1620];   //[nhits]
   Int_t           hit_pk[1620];   //[nhits]
   Int_t           hit_t[1620];   //[nhits]
   Int_t           hit_ch[1620];   //[nhits]
   Int_t           hit_fwhh[1620];   //[nhits]
   Double_t        hit_rms[1620];   //[nhits]
   Double_t        hit_nelec[1620];   //[nhits]
   Double_t        hit_energy[1620];   //[nhits]
   Float_t         hit_dQds[1620];   //[nhits]
   Float_t         hit_dEds[1620];   //[nhits]
   Float_t         hit_ds[1620];   //[nhits]
   Float_t         hit_resrange[1620];   //[nhits]
   Float_t         hit_x[1620];   //[nhits]
   Float_t         hit_y[1620];   //[nhits]
   Float_t         hit_z[1620];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4430];   //[maxTrackIDE]
   Double_t        IDEPos[4430][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[413];   //[geant_list_size]
   Double_t        Eng[413];   //[geant_list_size]
   Double_t        Px[413];   //[geant_list_size]
   Double_t        Py[413];   //[geant_list_size]
   Double_t        Pz[413];   //[geant_list_size]
   Double_t        EndEng[413];   //[geant_list_size]
   Double_t        EndPx[413];   //[geant_list_size]
   Double_t        EndPy[413];   //[geant_list_size]
   Double_t        EndPz[413];   //[geant_list_size]
   Double_t        StartPointx[413];   //[geant_list_size]
   Double_t        StartPointy[413];   //[geant_list_size]
   Double_t        StartPointz[413];   //[geant_list_size]
   Double_t        EndPointx[413];   //[geant_list_size]
   Double_t        EndPointy[413];   //[geant_list_size]
   Double_t        EndPointz[413];   //[geant_list_size]
   Int_t           Process[413];   //[geant_list_size]
   Int_t           NumberDaughters[413];   //[geant_list_size]
   Int_t           Mother[413];   //[geant_list_size]
   Int_t           TrackId[413];   //[geant_list_size]
   Int_t           process_primary[413];   //[geant_list_size]
...
#ifdef Kaon_cxx
Kaon::Kaon(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/KaonMinusMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/KaonMinusMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/KaonMinusMC.root:/anatree");
...
Int_t Kaon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Kaon::LoadTree(Long64_t entry)
{
